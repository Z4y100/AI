...
<head>
	...
	<link rel="stylesheet" href="funciones/validar.php">
	<link rel="stylesheet" href="funciones/salir.php">
	        ...
	        <a href="#" class="Notification" id="notifation-unread-1">
	            ...
	            <div class="Notification-text">
	                <p>
	                    ...
	                    <strong>Nuevo Registro de Clientes</strong> 
	                    <br>
				...
				<nav class="navBar-options-list">
					<ul class="list-unstyle">
						...
						<li class="btn-exit" id="btn-exit">
							...
							<div class="mdl-tooltip" for="btn-exit">Cerrar Sesión
